...
import 'package:hospitals/views/hospitalList/hospitalList_page.dart';
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
        ...
        //   log('PhotoViewerArbnbPage');
        //   if (settings.name == PhotoViewerArbnbPage.routeName) {
        //     log('PhotoViewerArbnbPage');
        //     return PageRouteBuilder(
        //         pageBuilder: (_, __, ___) => PhotoViewerArbnbPage(),
        //         opaque: false);
        //   }
        ...
        routes: {
          ...
          PhotosGridPage.routeName: (context) => PhotosGridPage(),
          PhotoViewerArbnbPage.routeName: (context) =>
              PhotoViewerArbnbPage('', 0),
        },
        theme: ThemeData(
